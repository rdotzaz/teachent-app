...
void main() {
  group('Date formatter', () {
    ...
    test('timeString method', () {
      expect(
        DateFormatter.timeString(const TimeOfDay(hour: 11, minute: 5)),
        '11:05');
      expect(
        DateFormatter.timeString(const TimeOfDay(hour: 10, minute: 0)),
        '10:00');
      expect(
        DateFormatter.timeString(null), ':00');
    });

    test('onlyTimeString method', () {
      expect(
        DateFormatter.onlyTimeString(DateTime(2022, 04, 04, 11, 8)),
        '11:08');
      expect(
        DateFormatter.onlyTimeString(DateTime(2022, 04, 04)),
        '12:00');
    });

    test('onlyDateString method', () {
      expect(
        DateFormatter.onlyDateString(DateTime(2022, 05, 11)),
        '2022-05-11');
      expect(
        DateFormatter.onlyDateString(DateTime(2022, 12, 1)),
        '2022-12-01');
    });
  });
}