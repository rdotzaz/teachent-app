...
class _LessonDateCreationPageState extends State<LessonDateCreationPage> {
  ...
  Widget _cycledSelecting() {
    return BlocBuilder<FrequencyBloc, int>(
      builder: (context, _) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
            height: 50,
            padding: const EdgeInsets.all(5),
            child: BlocBuilder<FrequencyBloc, int>(
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ActionChip(
                        ...
                        onPressed: () =>
                            context.read<FrequencyBloc>().add(ToggleFreqencyEvent(index)));
                  });
              }
            ))
      ]),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
            height: 50,
            padding: const EdgeInsets.all(5),
            child: BlocBuilder<ToolBloc, List<bool>>(
              builder: (_, indexes) {
                return ListView.builder(
                  scrollDirection: Axis.horizontal,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
            height: 50,
            padding: const EdgeInsets.all(5),
            child: BlocBuilder<PlaceBloc, List<bool>>(
              builder: (_, indexes) {
                return ListView.builder(
                  scrollDirection: Axis.horizontal,
