...
class ReportCreationPageController extends BaseController {
    ...
    Future<void> init() async {
        ...
        for (final lesson in foundLessons) {
            ...
            if (student == null || lessonDate == null) {
                print('No student ${lesson.studentId} or lessondate ${lesson.lessonDateId} found');
                continue;
            }
    ...
    void saveReport(BuildContext context) async {
        if (_formKey.currentState?.validate() ?? false) {
            ...
            await ReportManager.create(dataManager, lessonMap[selectedMapKey]!.lesson, title, description);
